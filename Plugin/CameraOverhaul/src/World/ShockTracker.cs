...
internal static class ShockTracker
{
    ...
    internal static MethodBase GetInterfaceMethod(string name)
    {
...
{
    private static MethodBase TargetMethod() => ShockTracker.GetInterfaceMethod("ShockWithGun");
...
{
    private static MethodBase TargetMethod() => ShockTracker.GetInterfaceMethod("StopShockingWithGun");
